  ...
  function initAutocomplete() {
    ...
    var info = '<button onclick="deleteMarker()" type="button" name="button"><i class="material-icons">delete</i></button>';
    ...
    function addMarkerToArray(marker){
      ...
      marker.addListener('click', (position) => displayInfo(position, marker));
      console.log('Saved');
    ...
    function displayInfo(position, marker){
